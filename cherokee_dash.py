...
latitude_3D = 34.23
longitude_2D = -84.42
longitude_3D = longitude_2D
min_zoom = 8
max_zoom = 15
zoom_2D = 8.6  # lower values zoom out, higher values zoom in
zoom_3D = 8.2
map_height = 575
...
sub_geos_list = [
    'Woodstock/South Cherokee', 
    'Canton/Central Cherokee', 
    'East Cherokee', 
    'West Cherokee'
]
...
def mapper_2D():
    ...
    # read in geospatial
    gdf = gpd.read_file('Data/cherokee_CTs_simp.gpkg')
